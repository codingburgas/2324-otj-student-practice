...
void Sofia(string username) {
    ...
    vector<Movie> movies = {
        {1, "Godzilla", {"11:00", "13:40", "18:15"}},
        {2, "Colors of Evil", {"14:00", "19:30", "21:00"}},
        {3, "Ouija", {"17:30", "20:40", "22:30"}},
        {4, "Irish Wish", {"10:30", "14:10", "17:00"}},
        {5, "The Croods", {"13:00", "15:20", "18:30"}}
    };

    std::map<char, vector<int>> seats = {
        {'A', {1, 2, 3, 4, 5, 6}},
        {'B', {1, 2, 3, 4, 5, 6}},
        {'C', {1, 2, 3, 4, 5, 6}},
        {'D', {1, 2, 3, 4, 5, 6}},
